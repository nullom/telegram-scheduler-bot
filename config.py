...
class Config:
    ...
    def __init__(self, env_file: str = ".env"):
        ...
        if os.path.exists(env_file):
            ...
            self.logger.warning(f"Environment file {env_file} not found, using system environment variables only")
    ...
    def _load_config(self) -> None:
        ...
        scheduled_times_str = os.getenv("SCHEDULED_TIMES", "07:07,09:15,13:13,15:15,17:17,19:19,21:21")
    ...
    def _parse_scheduled_times(self, times_str: str) -> List[str]:
        ...
        for time_str in times_str.split(","):
            ...
            if self._validate_time_format(time_str):
                ...
                self.logger.warning(f"Invalid time format: {time_str}, skipping")
        
        if not times:
            # Fallback to default times if none are valid
            default_times = ["07:07", "09:15", "13:13", "15:15", "17:17", "19:19", "21:21"]
            self.logger.warning(f"No valid scheduled times found, using defaults: {default_times}")
    ...
    def _validate_config(self) -> None:
        ...
        elif not (self.bot_token and ":" in self.bot_token and len(self.bot_token.split(":")) == 2):
            errors.append("BOT_TOKEN appears to be invalid (should be in format: XXXXXXXXX:XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX)")
        ...
        if self.channel_id is None:
            ...
            errors.append("CHANNEL_ID must be negative for channels (should start with -100)")
    ...
    def is_development_mode(self) -> bool:
        ...
        """
        return os.getenv("DEVELOPMENT", "false").lower() in ("true", "1", "yes")
